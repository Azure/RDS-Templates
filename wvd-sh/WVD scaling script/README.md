...
The  PowerShell script (basicScale.ps1), an xml file to control the script's behavior (Config.xml), and documentation explaining how to deploy the script (Azure WVD Auto-Scaling-v1.docx). 