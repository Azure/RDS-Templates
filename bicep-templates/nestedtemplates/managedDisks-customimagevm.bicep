@description('The base URI where artifacts required by this template are located. TODO: Update all nested templates to point to bicep master folder after merge')
